...
4. Name the Lambda Function "Schrute-Quotes-Example-Skill".
...
2. Set "SchruteQuotes" as the skill name and "Schrute quotes" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, Ask Schrute quotes for a Schrute quote."
